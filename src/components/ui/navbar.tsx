...
const Navbar = () => {
    ...
    return (
        ...
        <nav className="fixed left-0 right-0 top-0 w-[calc(100%-2rem)] mt-4 mx-auto px-4 md:px-6 lg:px-12 py-4 flex justify-between items-center bg-white bg-opacity-70 backdrop-blur-md shadow-md z-50 max-w-screen-xl rounded-xl border border-gray-200">
            ...
            <li>
                <Link href="/" className="text-gray-700 hover:text-red-600 transition-colors duration-300" onClick={() => setMenuOpen(false)}>Tentang Kami</Link>
            </li>
            <li>
                <Link href="/" className="text-gray-700 hover:text-red-600 transition-colors duration-300" onClick={() => setMenuOpen(false)}>Layanan</Link>
            </li>
            <li>
                <Link href="/artikel" className="text-gray-700 hover:text-red-600 transition-colors duration-300" onClick={() => setMenuOpen(false)}>Artikel</Link>
            </li>
            <li>
                <Link href="/" className="text-gray-700 hover:text-red-600 transition-colors duration-300" onClick={() => setMenuOpen(false)}>Hubungi Kami</Link>
            </li>
            <li>
